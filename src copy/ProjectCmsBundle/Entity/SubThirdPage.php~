...

{
    ...
    /**
     * @var ProjectCmsBundle\Entity\SubPage
     *
     * @ORM\ManyToOne(targetEntity="ProjectCmsBundle\Entity\SubPage")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="subpage_id", referencedColumnName="id")
     * })
     */
    private $subpageId;
	...
	*/
     ...
     * Set subpageId
     *
     * @param \ProjectCmsBundle\Entity\SubPage $subpageId
     *
     * @return SubThirdPage
     */
    public function setSubpageId(\ProjectCmsBundle\Entity\SubPage $subpageId = null)
    {
     ...
     * Get subpageId
     *
     * @return \ProjectCmsBundle\Entity\SubPage
     */
