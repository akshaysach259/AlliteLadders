...
class SubPage
{
    ...
    /**
     * @var ProjectCmsBundle\Entity\MainPage
     *
     * @ORM\ManyToOne(targetEntity="ProjectCmsBundle\Entity\MainPage")
     * @ORM\JoinColumns({
	...
	*/
     ...
     * Set mainPage
     *
     * @param \ProjectCmsBundle\Entity\MainPage $mainPage
     *
     * @return SubPage
     */
    public function setMainPage(\ProjectCmsBundle\Entity\MainPage $mainPage = null)
    {
     ...
     * Get mainPage
     *
     * @return \ProjectCmsBundle\Entity\MainPage
     */
     ...
     * Set mainpageId
     *
     * @param \ProjectCmsBundle\Entity\MainPage $mainpageId
     *
     * @return SubPage
     */
    public function setMainpageId(\ProjectCmsBundle\Entity\MainPage $mainpageId = null)
    {
