 ...
 */
class ProjectPage extends \ProjectCmsBundle\Entity\ProjectPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'projectName', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'projectcatId', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'firstimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'secondimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'thirdimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'forthimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'fifthimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProjectPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectPage $proxy) {
    ...
    public function setProjectcatId(\ProjectCmsBundle\Entity\ProjectMainPage $projectcatId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProjectcatId', [$projectcatId]);

        return parent::setProjectcatId($projectcatId);
    }
    ...
    public function getProjectcatId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProjectcatId', []);

        return parent::getProjectcatId();
    }
