 ...
 */
class ProductPage extends \ProjectCmsBundle\Entity\ProductPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'productName', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'shortDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'productcatId', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'firstimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'secondimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'thirdimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'forthimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'fifthimage', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\ProductPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductPage $proxy) {
    ...
    public function setProductmainpagecatId(\ProjectCmsBundle\Entity\ProductMainPage $productmainpagecatId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductmainpagecatId', [$productmainpagecatId]);

        return parent::setProductmainpagecatId($productmainpagecatId);
    }
    ...
    public function getProductmainpagecatId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductmainpagecatId', []);

        return parent::getProductmainpagecatId();
    }
    ...
    public function setProductsubcatId(\ProjectCmsBundle\Entity\ProductSubPage $productsubcatId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductsubcatId', [$productsubcatId]);

        return parent::setProductsubcatId($productsubcatId);
    }
    ...
    public function getProductsubcatId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductsubcatId', []);

        return parent::getProductsubcatId();
    }
    ...
    public function setProductcatId(\ProjectCmsBundle\Entity\ProductMainPage $productcatId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductcatId', [$productcatId]);

        return parent::setProductcatId($productcatId);
    }
    ...
    public function getProductcatId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductcatId', []);

        return parent::getProductcatId();
    }
