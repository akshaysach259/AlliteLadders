 ...
 */
class MainPage extends \ProjectCmsBundle\Entity\MainPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'pageTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\MainPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MainPage $proxy) {
