 ...
 */
class MsfabricationPage extends \ProjectCmsBundle\Entity\MsfabricationPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'pageTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\MsfabricationPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MsfabricationPage $proxy) {
