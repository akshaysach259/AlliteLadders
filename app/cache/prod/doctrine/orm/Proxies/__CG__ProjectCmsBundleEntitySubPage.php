 ...
 */
class SubPage extends \ProjectCmsBundle\Entity\SubPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'pageTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'mainpageId', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubPage $proxy) {
    ...
    public function getMainPage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMainPage', []);
    ...
    public function setMainpageId(\ProjectCmsBundle\Entity\MainPage $mainpageId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMainpageId', [$mainpageId]);

        return parent::setMainpageId($mainpageId);
    }
    ...
    public function getMainpageId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMainpageId', []);

        return parent::getMainpageId();
    }
