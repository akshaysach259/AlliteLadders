 ...
 */
class VideosPage extends \ProjectCmsBundle\Entity\VideosPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'pageTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'youtubeCode', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'displayonhomepage', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\VideosPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VideosPage $proxy) {
    ...
    public function setYoutubeCode($youtubeCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setYoutubeCode', [$youtubeCode]);

        return parent::setYoutubeCode($youtubeCode);
    }
    ...
    public function getYoutubeCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getYoutubeCode', []);

        return parent::getYoutubeCode();
    }
    ...
    public function setDisplayonhomepage($displayonhomepage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDisplayonhomepage', [$displayonhomepage]);

        return parent::setDisplayonhomepage($displayonhomepage);
    }
    ...
    public function getDisplayonhomepage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDisplayonhomepage', []);

        return parent::getDisplayonhomepage();
    }
