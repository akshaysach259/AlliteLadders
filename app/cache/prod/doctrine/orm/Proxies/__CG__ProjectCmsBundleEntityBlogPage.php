 ...
 */
class BlogPage extends \ProjectCmsBundle\Entity\BlogPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'blogTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'feature', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\BlogPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlogPage $proxy) {
    ...
    public function setBlogTitle($blogTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBlogTitle', [$blogTitle]);

        return parent::setBlogTitle($blogTitle);
    }
    ...
    public function getBlogTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBlogTitle', []);

        return parent::getBlogTitle();
    }
