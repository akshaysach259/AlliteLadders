 ...
 */
class SubThirdPage extends \ProjectCmsBundle\Entity\SubThirdPage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'id', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'pageTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'pageUrl', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'pageDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'subpageId', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'metaTitle', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'metaDescription', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'metaKeyword', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'status', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'priority', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'image', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'created', '' . "\0" . 'ProjectCmsBundle\\Entity\\SubThirdPage' . "\0" . 'updated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubThirdPage $proxy) {
    ...
    public function setSubpageId(\ProjectCmsBundle\Entity\SubPage $subpageId = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubpageId', [$subpageId]);

        return parent::setSubpageId($subpageId);
    }
    ...
    public function getSubpageId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubpageId', []);

        return parent::getSubpageId();
    }
