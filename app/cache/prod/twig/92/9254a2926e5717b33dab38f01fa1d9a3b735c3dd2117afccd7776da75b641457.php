...
class __TwigTemplate_75b8b393fbc1b5dff2b45a8b6dc8ed2459d26f60838e61618012e13f1b57c8ba extends Twig_Template
{
...
<section class=\"sec-space-bottom\">
        ...
        // line 13
        if ($this->getAttribute($this->getAttribute(($context["result"] ?? null), 0, array(), "array", false, true), "pageTitle", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute($this->getAttribute(($context["result"] ?? null), 0, array(), "array"), "pageTitle", array())), "html", null, true);
        }
        echo "</span></h2>
                                    </div>
                                    <div class=\"caption\">";
    ...
    {
        return array (  55 => 17,  51 => 16,  44 => 13,  36 => 8,  31 => 4,  28 => 3,  11 => 1,);
    }
